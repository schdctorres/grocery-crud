...
$config['addBtnValue']    =  "ADD NEW RECORD";
$config['jScriptIncludesFirst'] = "";
$config['jScriptIncludesFirst'] = array(
        array("src" => "/assets/grocery_crud/js/jquery-1.11.1.min.js", "type"=>"text/javascript"),
        array("src" => "/assets/grocery_crud/js/jquery_plugins/ui/jquery-ui-1.10.3.custom.min.js", "type"=>"text/javascript"),
        array("src" => "/includes/js/less.js/dist/less.js", "type"=>"text/javascript")
);
$GLOBALS['javascriptIncludes']['jQueryUI']="";
$GLOBALS['javascriptIncludes']['Validation'] ="";
/*
    array(
    "/includes/js/jquery-validate/jquery.validate.js",
    "/includes/js/jquery-validate/additional-methods.js");
*/
